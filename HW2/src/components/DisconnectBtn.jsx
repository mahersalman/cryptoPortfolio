    ...
    async function disconnectWallet() {
      ...
      return (
        <button
          ...
          className="bg-[#e03636] dark:bg-blue-600 text-black dark:text-white font-bold p-4 text-xl rounded-2xl hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500"
        >
          Disconnect
        </button>
      );
